...
class LessonResourceIT {
    ...
    public static Lesson createEntity(EntityManager em) {
        Lesson lesson = new Lesson().title(DEFAULT_TITLE).slug(DEFAULT_SLUG).description(DEFAULT_DESCRIPTION).level(DEFAULT_LEVEL);
        return lesson;
    }
    ...
    public static Lesson createUpdatedEntity(EntityManager em) {
        Lesson lesson = new Lesson().title(UPDATED_TITLE).slug(UPDATED_SLUG).description(UPDATED_DESCRIPTION).level(UPDATED_LEVEL);
        return lesson;
    }
    ...
    void createLesson() throws Exception {
        ...
        assertThat(testLesson.getSlug()).isEqualTo(DEFAULT_SLUG);
    ...
    void putExistingLesson() throws Exception {
        ...
        updatedLesson.title(UPDATED_TITLE).slug(UPDATED_SLUG).description(UPDATED_DESCRIPTION).level(UPDATED_LEVEL);
        ...
        assertThat(testLesson.getSlug()).isEqualTo(UPDATED_SLUG);
    ...
    void partialUpdateLessonWithPatch() throws Exception {
        ...
        partialUpdatedLesson.title(UPDATED_TITLE).slug(UPDATED_SLUG).level(UPDATED_LEVEL);
    ...
    void fullUpdateLessonWithPatch() throws Exception {
        ...
        partialUpdatedLesson.title(UPDATED_TITLE).slug(UPDATED_SLUG).description(UPDATED_DESCRIPTION).level(UPDATED_LEVEL);
